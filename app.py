...
# Grid coordinates for the contour (center of cells)
...
with col1:
    ...
    # FIX: Ensure target is within the actual data range
...
for d in [0, 0.05, 0.10, 0.15, 0.20, 0.25]:
    ...
    tradeoff_data.append({"Total Discount %": f"{d:.0%}", "Required Volume": req_v_str, "Volume Growth Needed": growth_str})
